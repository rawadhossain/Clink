		...
		return (
			<button
				...
				className={cn(
					...
					// Removed: "[[data-side=left]_&]:cursor-w-resize [[data-side=right]_&]:cursor-e-resize",
					// Removed: "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
				...
				{...props}
				disabled // Add this attribute to disable the button
			/>
		);
	}
);
